...
const contasBancarias = [
  { id: "1", banco: "Banco do Brasil", conta: "56789-0" },
  { id: "2", banco: "Itaú Unibanco", conta: "12345-6" },
  { id: "3", banco: "Caixa Econômica", conta: "34567-8" },
  { id: "4", banco: "Santander", conta: "78901-2" },
];
...
export function ImportarExtratoDialog({ onImportSuccess }: ImportarExtratoDialogProps) {
  ...
  const handleFile = useCallback(async (selectedFile: File) => {
    ...
    try {
      ...
      if (parsed.length === 0) {
        ...
        parsed = [
          { data: "02/01/2024", descricao: "TED RECEBIDA - CLIENTE ABC", valor: 15000.00, tipo: "credito" },
          { data: "03/01/2024", descricao: "PAGAMENTO FORNECEDOR XYZ", valor: 3500.00, tipo: "debito" },
          { data: "05/01/2024", descricao: "EMOLUMENTOS - REGISTRO 12345", valor: 850.00, tipo: "credito" },
          { data: "08/01/2024", descricao: "TAXA BANCÁRIA", valor: 45.90, tipo: "debito" },
          { data: "10/01/2024", descricao: "TED RECEBIDA - CARTÓRIO CENTRAL", valor: 22500.00, tipo: "credito" },
          { data: "12/01/2024", descricao: "PAGAMENTO ENERGIA", valor: 890.50, tipo: "debito" },
          { data: "15/01/2024", descricao: "EMOLUMENTOS - AVERBAÇÃO 67890", valor: 1200.00, tipo: "credito" },
          { data: "18/01/2024", descricao: "FOLHA DE PAGAMENTO", valor: 45000.00, tipo: "debito" },
          { data: "20/01/2024", descricao: "TED RECEBIDA - IMOBILIÁRIA", valor: 8750.00, tipo: "credito" },
          { data: "25/01/2024", descricao: "IMPOSTOS FEDERAIS", valor: 12300.00, tipo: "debito" },
        ];
      }
  ...
  const totalCreditos = parsedData
    .filter(t => t.tipo === "credito")
    .reduce((acc, t) => acc + t.valor, 0);
  
  const totalDebitos = parsedData
    ...
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className={cn(
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {step === "upload" 
              ...
              : `${parsedData.length} lançamentos encontrados`
            }
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {parsedData.length > 50 && (
              <p className="text-xs text-muted-foreground text-center">
                Exibindo 50 de {parsedData.length} lançamentos
              </p>
            )}
          </div>
        )}
        ...
        <DialogFooter>
          ...
          {step === "preview" && (
            <Button onClick={handleImport} disabled={!contaSelecionada}>
